...
export function CVTemplate4({ cvData, primaryColor, fontFamily }: CVTemplate4Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white" style={{ fontFamily }}>
      ...
      <header className="relative mb-8 overflow-hidden">
          ...
          <div className="relative z-10 p-8 text-white">
            <div className="flex items-end gap-6">
              ...
              <div className="flex-1 pb-4">
                <h1 className="text-4xl font-bold mb-2">{cvData.fullName || "Seu Nome"}</h1>
                <h2 className="text-xl opacity-90">{cvData.jobTitle || "Sua Profissão"}</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Contact bar */}
        <div className="bg-gray-50 px-8 py-4 border-l-4" style={{ borderColor: primaryColor }}>
        ...
        {cvData.summary && (
          <section className="mb-8">
            <div className="bg-gray-50 p-6 rounded-lg border-l-4" style={{ borderColor: primaryColor }}>
              <p className="text-gray-700 leading-relaxed italic text-lg">{cvData.summary}</p>
            </div>
          </section>
        )}
        ...
        {cvData.experience.length > 0 && (
          <section className="mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800">Experiência Profissional</h3>
            </div>
            ...
            {cvData.certifications.length > 0 && (
              <section>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">Certificações</h3>
                </div>
